...
app.post('/api/ext-login', async (req, res) => {
    try {
        const response = await fetch('https://dufaty.com/api/ext-login', {
            method: 'POST',
            headers: {
...
app.get('/api/ext-balance', async (req, res) => {
    try {
        ...
        const response = await fetch('https://dufaty.com/api/ext-balance', {
            method: 'GET',
            headers: {
...
app.get('/api/ext-profile', async (req, res) => {
    try {
        ...
        const response = await fetch('https://dufaty.com/api/ext-profile', {
            method: 'GET',
            headers: {
                'Authorization': authToken
            }
...
app.get('/api/ext-logout', async (req, res) => {
    try {
        ...
        const response = await fetch('https://dufaty.com/api/ext-logout', {
            method: 'GET',
            headers: {
                'Authorization': authToken
            }
...
app.get('/api/ext-transaction', async (req, res) => {
    try {
        ...
        const apiUrl = `https://dufaty.com/api/ext-transaction?page=${page}&page_size=${pageSize}&page_count=${pageCount}&start_date=${startDate}&end_date=${endDate}&status_filter=${statusfilter}`;
...
app.put('/api/ext-transaction', async (req, res) => {
    try {
        ...
        const response = await fetch('https://dufaty.com/api/ext-transaction', {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': authToken
...
app.put('/api/ext-profile', async (req, res) => {
    try {
        ...
        console.log('Sending request to external API:', 'https://dufaty.com/api/ext-profile');
        const response = await fetch('https://dufaty.com/api/ext-profile', options);
...
app.get('/api/ext-transaction-count', async (req, res) => {
    try {
        ...
        const apiUrl = `https://dufaty.com/api/ext-transaction?filter=${filterQuery}`;
...
app.get('/api/ext-check-auth', async (req, res) => {
    try {
        ...
        const apiUrl = `https://dufaty.com/api/ext-check-auth?email=${email}`;
...
app.get('/api/ext-check-connected-site', async (req, res) => {
    ...
    try {
        const apiUrl = `https://dufaty.com/api/ext-check-connected-site?domain=${domain}`;
...
app.get('/api/forgot-password', (req, res) => {
    res.json({ forgotPassword: "https://dufaty.com/forgot-password/" });
});

app.get('/api/buy-aed', (req, res) => {
    res.json({ buyAED: "https://dufaty.com/payment/" });
});
...
app.get('/api/ext-transaction-pdf', async (req, res) => {
    try {
        ...
        const apiUrl = `https://dufaty.com/api/ext-transaction-pdf/?start_date=${startDate}&end_date=${endDate}`;
...
app.post('/api/send-message-email', async (req, res) => {
    try {
        ...
        const response = await fetch('http://dufaty.com/api/send-message-email/', {
            method: 'POST',
            headers: {
                'Authorization': authToken,
                'Content-Type': 'application/json',
